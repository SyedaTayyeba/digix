...
// Case studies - temporarily disabled until public controller exists
/*
Route::prefix('case-studies')->name('case-studies.')->group(function () {
    Route::get('/', [CaseStudyController::class, 'index'])->name('index');
    Route::get('/{slug}', [CaseStudyController::class, 'show'])->name('show');
});
*/
...
Route::prefix('pricing')->name('pricing.')->group(function () {
    ...
    Route::get('/{slug}', [PricingController::class, 'show'])->name('show');
});
